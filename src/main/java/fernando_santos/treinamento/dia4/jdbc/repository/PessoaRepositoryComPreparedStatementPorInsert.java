...
public class PessoaRepositoryComPreparedStatementPorInsert {
	
	private final Connection connection;

	public PessoaRepositoryComPreparedStatementPorInsert(Connection connection) throws SQLException {
		this.connection = connection;
	}
	
	public void insert(Pessoa pessoa) throws SQLException {
		PreparedStatement ps = connection.prepareStatement("insert into pessoa (id, codigo, nome) values (?, ?, ?)");
		ps.clearParameters();
	...
	public void deleteAll() throws SQLException {
		PreparedStatement ps = connection.prepareStatement("delete from pessoa");
		ps.execute();
	}
